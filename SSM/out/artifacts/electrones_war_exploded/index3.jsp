...
<html>
  ...
  <tr> 
    ...
    <td bgcolor="F8F8F8" height="45" width="386"> 
      <div align="center"><img src="<%=request.getContextPath() %>/IMAGES/02.gif" width="338" height="31"></div>
    </td>
    <td bgcolor="F8F8F8" height="40" width="386" valign="middle">      <div align="left">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td width="1%">&nbsp;</td>
            <td width="33%">&nbsp;</td>
            <td width="23%"><a href="login.jsp"><img src="IMAGES/03.gif" width="70" height="22" border="0"></a></td>
            <td width="21%"><a href="login.jsp"><img src="IMAGES/04.gif" width="69" height="22" border="0"></a></td>
            <td width="22%"><a href="<%=request.getContextPath() %>/admin_manager/managerindex.jsp"><img src="IMAGES/05.gif" width="69" height="22" border="0"></a></td>
          </tr>
        </table>
      </div>
    </td>
          ...
          <td width="185" valign="top"> 
            ...
            <table width="185" border="0" cellspacing="0" cellpadding="0">
              <tr bgcolor="D6E3F9">
                ...
                <%
                	News news = (News)session.getAttribute("typ1");
			    	Usr user = (Usr)session.getAttribute("user");
			    	if(user!=null){
			    %>
			    		<%=user.getNickname()%>，你好。<br><br>
			    		<a href="<%=path%>/myIssuenewsAction.action">我发布的</a><br><br>
			    		<a href="<%=path%>/jsp/authauthAction.action">管理</a><br><br>
			    		<%
			    			if("1".equals(user.getAuth())){
			    		%>
			    				<a href="<%=path%>/jsp/authmanager.jsp">权限管理</a>
			    		<%
			    			}
			    		%>
			    		<a href="<%=path%>/exitAction.action">退出</a>
			    <%
			    	} else {
			    		String tip = (String)request.getAttribute("tip");
			    %>
			    <form name="form0" action="loginAction.action" method="post">
                  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                  	<tr>
                  		<td	colspan="3">
                    ...
                    <tr align="center" valign="bottom">
                      ...
                      <INPUT name=queding src="<%=path%>/IMAGES/enter.jpg" type=image  onclick="return validate();">
                        <a href="javascript:reset()"><IMG src="<%=path%>/IMAGES/cancel.jpg" width=64 height=22 border="0"></a>
                      </td>
                      </tr>
                    <tr align="center" valign="bottom">
                                  		...
                                  		<tr>
                                  			<td height="10" align="right">
                                  				<%
                                  					if(news!=null){
                                  				%>
                                  						<a href="viewnewsAction.action?id=<%=news.getId()%>" target="_blank"><font color="#3333FF"> &gt;&gt;详细内容</font></a>
                                  				<%
                                  					} else {
                                  				%>
                                  						&nbsp;
...
<br>
<map name="Map">
  <area shape="rect" coords="111,6,193,25" href="fagui/fagui.htm">
  <area shape="rect" coords="231,6,311,25" href="sldrc/szrc.htm">
  <area shape="rect" coords="352,5,431,25" href="bbs/index.htm">
  <area shape="rect" coords="473,5,553,27" href="wenjian/wenjian.htm">
</map>
</body>
</html>
